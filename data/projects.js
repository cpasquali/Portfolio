export const projects = [
  {
    ...
    resume:
      "Landing Spotify es un proyecto académico desarrollado utilizando HTML y CSS, que consiste en la recreación de la landing page de Spotify, con el objetivo de replicar su diseño y estructura visual de manera fiel.",
  },
  {
    name: "Conifly",
    ...
    resume:
      "Conifly es un proyecto web desarrollado con HTML, CSS, Sass y Bootstrap, que consiste en la recreación de la página de una aerolínea, destacando su diseño y estructura visual.",
  },
  {
    name: "Cinemania",
    ...
    resume:
      "Cinemania es una aplicación web desarrollada con React que utiliza la API de TMDb para mostrar información sobre películas y series. Los usuarios pueden registrarse, iniciar sesión y guardar sus películas favoritas, almacenándolas en el localStorage.",
  },
  {
    name: "Pokeviewer",
    ...
    resume:
      "PokeViewer es una aplicación web desarrollada con React, CSS y Bootstrap, que utiliza la API de PokeAPI para mostrar información de los Pokémon. Los usuarios pueden explorar los Pokémon y guardar sus favoritos en el localStorage.",
  },
  {
    ...
    resume:
      "Musical instrument simulator es una aplicación web desarrollada con React y la libreria tone.Js que simula un instrumento musical. Los usuarios pueden interactuar presionando las teclas del teclado en PC o tocando la pantalla en dispositivos móviles para reproducir los sonidos correspondientes a distintas notas musicales.",
  },
  {
